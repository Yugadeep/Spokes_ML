...
def main():
    ...
    X, Y = [], []
    X, Y = model_utility.data_gather_YK(X, Y, rpjb_list_path, mask_list_path)
    ...
    model = model_utility.unet_model((SIZE_Y, SIZE_X, 1))  # YK edit
    ...
    print("saving model ...")
    model_utility.save_model_history(model_path, history, results)
    print("model saved!")
